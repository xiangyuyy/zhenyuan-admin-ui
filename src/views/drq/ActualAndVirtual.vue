  ...
  <div class="app-container">
    ...
    <div class="tableContainer">
      ...
      >
        ...
        <el-table-column prop="shopName" label="实际门店" align="center">
        </el-table-column>
        <el-table-column
          prop="drugShopName"
          label="药监门店（虚挂）"
...
import { getsjxgMemberList, exportsjxgMemberList } from "@/api/dataReport";
const defaultForm = {
  shopId: null,
  pageNum: 1,
  pageSize: 5,
...
export default {
  ...
  methods: {
    getTableData() {
      getsjxgMemberList(this.queryForm).then((res) => {
        if (res.code === 200) {
    ...
    exportExcel() {
      exportsjxgMemberList(this.queryForm).then((res) => {
        ...
        downloadElement.download = time + "实际虚挂人员.xlsx";
